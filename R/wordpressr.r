#' @title wordpressr: easy blogging with WordPress and RMarkdown
#'
#' @description Functions for working with the WordPress API and easy integration with RMarkdown
#'
#' @details This package has high level functions for working with the WordPress API and wrapper functions for working with RMarkdown.
#' 
